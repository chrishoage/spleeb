  ...
  body: (p) => {
    if (p.param.variant == "4_pin_smd") {
      return `
          ...
          (module E73:SW_TACT_ALPS_SKQGABE010 (layer F.Cu))
        ...
        p.param.side
      }.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.from.str})
              (pad 1 smd rect (at 3.1 -1.85 ${p.rot}) (size 1.8 1.1) (layers ${
        p.param.side
      }.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.from.str})
              (pad 2 smd rect (at -3.1 1.85 ${p.rot}) (size 1.8 1.1) (layers ${
        p.param.side
      }.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.to.str})
              (pad 2 smd rect (at 3.1 1.85 ${p.rot}) (size 1.8 1.1) (layers ${
        p.param.side
      }.Cu ${p.param.side}.Paste ${p.param.side}.Mask) ${p.net.to.str})
          )
      ...
      return `
        ...
        p.net.to.str
          ...
          `;
    } else if (p.param.variant === "4_pin_th_side") {
      return `
        (module SW_SKHLLCA010 (layer F.Cu) (tedit 61FC55F2)
            ...
            (fp_text reference "${p.ref}" (at -2.25 3.5) (layer "F.SilkS") ${
        p.ref_hide
      } (effects (font (size 1 1) (thickness 0.15))))

            (fp_text value "" (at 0 -0.75) (layer F.Fab) (effects (font (size 1 1) (thickness 0.15))))

            (fp_line (start -2.25 0.55) (end 2.25 0.55) (layer "F.SilkS") (width 0.12))
            (fp_line (start -3.9 -0.07) (end -3.9 -3.75) (layer "F.SilkS") (width 0.12))
            (fp_line (start -1.25 -3.75) (end -1.25 -5) (layer "F.SilkS") (width 0.12))
            (fp_line (start 3.9 -0.07) (end 3.9 -3.75) (layer "F.SilkS") (width 0.12))
            (fp_line (start -3.9 -3.75) (end 3.9 -3.75) (layer "F.SilkS") (width 0.12))
            (fp_line (start 1.25 -3.75) (end 1.25 -5) (layer "F.SilkS") (width 0.12))
            (fp_line (start -1.25 -5) (end 1.25 -5) (layer "F.SilkS") (width 0.12))
            (fp_line (start -2.25 0.55) (end 2.25 0.55) (layer "B.SilkS") (width 0.12))
            (fp_line (start -3.9 -0.07) (end -3.9 -3.75) (layer "B.SilkS") (width 0.12))
            (fp_line (start -1.25 -3.75) (end -1.25 -5) (layer "B.SilkS") (width 0.12))
            (fp_line (start 3.9 -0.07) (end 3.9 -3.75) (layer "B.SilkS") (width 0.12))
            (fp_line (start -3.9 -3.75) (end 3.9 -3.75) (layer "B.SilkS") (width 0.12))
            (fp_line (start 1.25 -3.75) (end 1.25 -5) (layer "B.SilkS") (width 0.12))
            (fp_line (start -1.25 -5) (end 1.25 -5) (layer "B.SilkS") (width 0.12))
            ...
            (pad "1" thru_hole circle (at 2.5 -1.25 ${
              p.rot
            }) (size 1.8 1.8) (drill 1) (layers *.Cu "*.Mask") ${p.net.to.str})
            (pad "2" thru_hole circle (at -2.5 -1.25 ${
              p.rot
            }) (size 1.8 1.8) (drill 1) (layers *.Cu "*.Mask") ${
        p.net.from.str
      })
            (pad "MP" thru_hole circle (at -3.5 1.25 ${
              p.rot
