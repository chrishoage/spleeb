...
(module OLED-128x32-double-sided (layer F.Cu) (tedit 61D90230)
  ...
  (pad "1" smd custom (at 3.251 9.8 ${
    ...
    ) ${p.net.SDA.str} (tstamp 453f4a68-122d-44bf-a828-c5d1029a227d))
  (pad "1" smd custom (at 3.251 2.18  ${
    ...
    ) ${p.net.SDA.str} (tstamp 7efbe668-94c3-40dc-89c1-c2ef37a7844a))
  (pad "2" smd custom (at 3.251 7.26 ${
    ...
    ) ${p.net.SCL.str} (tstamp 3bbd7815-8ad7-4d72-92c3-96826a0c302c))
  (pad "2" smd custom (at 3.251 4.72 ${
    ...
    ) ${p.net.SCL.str} (tstamp be8e71c5-6a5d-4355-890f-ba576fc74f3e))
  (pad "3" smd custom (at 3.251 7.26 ${
    ...
    ) ${p.net.VCC.str} (tstamp 32749c0b-3f32-4b9e-b6b7-926362372b0b))
  (pad "3" smd custom (at 3.251 4.72 ${
    ...
    ) ${p.net.VCC.str} (tstamp bbf3ffa2-6e2a-4d77-b6ab-83f8717260ae))
  (pad "4" smd custom (at 3.251 2.18 ${
    ...
    ) ${p.net.GND.str} (tstamp 3826d188-92e9-43ce-adfa-6e69d777dc8d))
  (pad "4" smd custom (at 3.251 9.8 ${
    ...
    ) ${p.net.GND.str} (tstamp aa0b421a-7030-40e4-a89c-403b61ce0783))
